...
export const updateProfile = async (req, res) => {
  try {
    ...
    if(userData?.profilePicPublicId){
      oldPublicId = userData?.profilePicPublicId;
    }
    ...
    if (oldPublicId && oldPublicId.trim() !== '') {
      ...
      uploadOptions.folder = 'ChatApp/profile';
    }
    ...
    if (uploadResponse.secure_url){
      const updatedUser = await User.findByIdAndUpdate(
        userId,
        { profilePic: uploadResponse.secure_url,profilePicPublicId:uploadResponse.public_id },
        { new: true }
      );
